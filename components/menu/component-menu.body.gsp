	...
	<ul class="navigation-items">
		...
		<li>
			<ul class="navigation-socials">
				...
				<li class="navigation-github"><a href="https://github.com/nokeedev" title="Nokee on GitHub">${gitHubLogo}</a></li>
			</ul>
		</li>
	</ul>
</nav>
